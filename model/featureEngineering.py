...
def reno_cost_for_real_data(
    ...
    # csv_path="processed_data/real_train_val_with_extracted_features_synonyms2.csv",
    # output_path="processed_data/real_train_val_with_predicted_reno_cost2.csv"
    
    csv_path="processed_data/real_test_with_extracted_features_synonyms2.csv",
    output_path="processed_data/real_test_with_predicted_reno_cost2.csv"
    
):
    df = pd.read_csv(csv_path)
    df = df.drop(columns=["description", "num_of_bedrooms", "num_of_bathrooms"], errors="ignore")
    ...
    df["renovation_cost"] = predictions
