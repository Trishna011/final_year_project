...
# -----------------------------
OPENING_MODES = [
    "Begin by describing the spatial organisation of the main living areas.",
    "Begin by focusing on how natural light is distributed through the interior.",
    "Begin by describing the internal layout and movement between rooms.",
    "Begin with the condition and clarity of the principal living space.",
    "Begin by describing how the interior presents on entry."
]
