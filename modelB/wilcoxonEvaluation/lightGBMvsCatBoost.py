...
lightgbm_real = pd.read_csv(
    "modelB/lightGBM/lightgbm_real_preds.csv"
)
...
lightgbm_syn = pd.read_csv(
    "modelB/lightGBM/lightgbm_synthetic_preds.csv"
)
...
lightgbm_errors_syn = absolute_percentage_error(
    lightgbm_syn["y_true"],
    lightgbm_syn["y_pred"]
)
