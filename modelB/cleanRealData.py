...
real_df = real_df.drop(columns=["Unnamed: 4"], errors="ignore")
...
real_df["description"] = real_df["Description"].apply(remove_renovation_words)
...
train_path = os.path.join(OUTPUT_DIR, "real_train_preprocessed.csv")
val_path = os.path.join(OUTPUT_DIR, "real_val_preprocessed.csv")
