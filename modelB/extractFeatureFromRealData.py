...
df_real = pd.read_csv("processed_data/real_train_val_preprocessed.csv")
...
df_extracted.to_csv("processed_data/real_train_val_with_extracted_features_synonyms.csv", index=False)
